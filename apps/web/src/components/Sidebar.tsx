...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "firestore",   label: "Firestore",        icon: Flame },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "dataproc",  label: "Dataproc",    icon: Server },
    ],
  },
  {
    label: "AI & ML",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "cdn",        label: "Cloud CDN",        icon: Globe },
      { id: "firewall",   label: "Firewall Rules",   icon: ShieldAlert },
    ],
  },
  {
    label: "Security",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "tasks",      label: "Cloud Tasks",       icon: ListTodo },
      { id: "deploy",     label: "Cloud Deploy",      icon: Rocket },
    ],
  },
  {
    label: "Operations",
    items: [
      ...
      { id: "logging",    label: "Cloud Logging",   icon: FileText },
